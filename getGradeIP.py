...
page = urlopen(
    'https://docs.google.com/spreadsheets/d/e/2PACX-1vSEKTIaD_1VFRyQfkjXlJU-AiKWTyOvgPtQkaGwYQKZsdvl56er2UEfG-BjOSOqkd06IFHL-XyggUCA/pubhtml#')
...
for i in range(1000):
    ...
    print('Acum esti al ' + str(pozitia_mea) + 'lea din ' + str(total_studenti_trecuti) + ', cu un procentaj de ' + str(
        procentajul_meu) + '%.')
